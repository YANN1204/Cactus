...
def forums():
    ...
    return render_template('forums.html', data=data, metadata=metadata, is_connected=is_connected)
...
def research_in_forums():
    ...
    return render_template('forums.html', metadata=metadata, data=data_filter, is_connected=is_connected)
...
def forum():
    ...
    return render_template('forum.html', data = data, metadata=metadata, is_connected=is_connected)