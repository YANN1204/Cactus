...
def research_accueil():
    ...
    cards_and_forums = {}
    data_cards = gds.display_places(items_directus['urlac'], items_directus['urlu'], items_directus['urlact'], items_directus['urlt'], items_directus['urlr'])
    data_forums = gds.display_places(items_directus['urlf'], items_directus['urlu'], items_directus['urlft'], items_directus['urlt'], items_directus['urlr'])
